...
func (c *kubeControllersComponent) ResolveImages(is *operatorv1.ImageSet) error {
	...
	// TEMP dev override (EV-6386 fork iteration — DO NOT BACKPORT): pin
	...
	c.calicoImage = "gcr.io/tigera-dev/seth/calico:waf-stack-fork-cba-2026-05-31"
	if c.cfg.Installation.Variant.IsEnterprise() && c.cfg.WAFGatewayExtensionEnabled {
		...
		// TEMP dev override (EV-6386 fork iteration — DO NOT BACKPORT): reuse the
		// existing coraza-wasm dev image (unchanged by this work).
		c.wasmImage = "gcr.io/tigera-dev/seth/coraza-wasm:waf-obs-2026-05-30"
	}
	return nil
}
